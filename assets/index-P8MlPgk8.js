...
`,v=new R(b);document.querySelector("#app").innerHTML=T;document.addEventListener("DOMContentLoaded",()=>{history.replaceState({},"",window.location.pathname),v.resolve().catch(s=>console.log(s))});document.addEventListener("click",s=>{const e=s.target;if(e instanceof HTMLElement){const t=e.getAttribute("href");t&&t.startsWith("/")&&(s.preventDefault(),v.navigate(t).catch(a=>console.log(a)))}});
